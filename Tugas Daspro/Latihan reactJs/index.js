const initTodoItems = [
    { index: 1, value: 'Matematika Dasar', done: false },
    { index: 2, value: 'Fisika Dasar', done: false },
    { index: 3, value: 'Sistem Teknologi Informasi', done: false },
    { index: 4, value: 'Dasar Pemrograman', done: false },
    { index: 5, value: 'Pengantar Teknik', done: false }
];
